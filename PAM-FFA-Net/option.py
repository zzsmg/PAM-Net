...
parser.add_argument('--net', type=str, default='Pam_ffa_1')  # Pam_ffa_1 or Pam_ffa_2
parser.add_argument('--loss', type=str, default='Total')  # Total or L1
parser.add_argument('--gps', type=int, default=3, help='residual_groups')
parser.add_argument('--blocks', type=int, default=19, help='residual_blocks')  # 19
